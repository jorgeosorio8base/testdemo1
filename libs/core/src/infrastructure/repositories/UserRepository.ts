...
export class UserRepository implements IUserRepository {
  ...
  async getUser(
    ...
    return this.http
      .requestGraphQL<{
        ...
        requestDocument: gql`
          query GET_USER($id: ID, $email: String) {
  ...
  async getUsersList(
    params: IRepositoryParams<QueryUsersListArgs>,
  ...
  async createUser(
    params: IRepositoryParams<MutationUserCreateArgs>,
  ): Promise<User | null> {
    return this.http
      .requestGraphQL<{
        userCreate: User;
      ...
      ?.then((response) => response.userCreate)
      ?.catch(() => null);
  }

  async deleteUser(
    params: IRepositoryParams<MutationUserDeleteArgs>,
  ...
  async updateUser(
    params: IRepositoryParams<MutationUserUpdateArgs>,
  ): Promise<User | null> {
    return this.http
      .requestGraphQL<{
        userUpdate: User;

...
import { MutationNotificationDeleteArgs } from '@testdemo1/core';
...
export function useDeleteNotification() {
  ...
  return useMutation<boolean, Error, MutationNotificationDeleteArgs>({
    mutationKey: ['NOTIFICATION_DELETE_MUTATION'],
    mutationFn: async (params) =>
      UseCases.Notification.deleteNotification({
        variables: params,
